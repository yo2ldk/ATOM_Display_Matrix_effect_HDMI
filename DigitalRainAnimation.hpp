...
#define FONT_SIZE 3               //set font size 2
#define LINE_WIDTH 30             //width for font size 2
#define LETTER_HEIGHT 35          //height for font size 2
...
private:
  ...
  void prepareAnim() {
    ...
    setHeadCharColor(255, 0, 0);  //Red                 (255, 255, 255) White 
    setTextColor(255, 255, 0);    //Yellow              (0, 255, 0)     Green
    setBGColor(0, 0, 100);        // Navy               (0, 0, 0)       Black
  ...
  void setBigText(bool isOn) {
    fontSize = isOn ? FONT_SIZE * 2.5 : FONT_SIZE;
    lineWidth = isOn ? LINE_WIDTH * 2.5 : LINE_WIDTH;
    letterHeight = isOn ? LETTER_HEIGHT * 3 : LETTER_HEIGHT;
  }
